...
Use of uninitialized value in string  in sub P5warn at lib/Perl5/Terms.pm:8<br />
   ...
   4 skipped: Unrecognized directive 'U'<br />
        ...
        <tr><td colspan='5'>use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in numeric context  in method P5Numeric at lib/Perl5/Terms.pm:339<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_9:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_14:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_19:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_24:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_29:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_34:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_39:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_44:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_49:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_54:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_59:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_64:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_69:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_74:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_79:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_84:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_89:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_94:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_99:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_104:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_109:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_114:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_119:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_124:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_129:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_134:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in string context  in block  at eval_139:1<br />
use of uninitialized value of type O=ARRAY(0x7182fd9f3a467568) in numeric context  in method P5Numeric at lib/Perl5/Terms.pm:339<br />
</td></tr>
...
to preserve list context inside function call<br />
  ...
  in method sink at src/gen/CORE.setting:11393<br />
...
Sorry, coredump is not yet implemented for this platform.<br />
  ...
  in method &lt;anon&gt; at src/gen/CORE.setting:11390<br />
...
current instr.: 'print_exception' pc 110428 (src/gen/CORE.setting.pir:48046) (src/gen/CORE.setting:10221)</td></tr>
...
Placeholder variable H^ash[0x5a25418] may not be used here because the surrounding block takes no signature<br />
...
Could not find file './test.pl' for module ./test.pl<br />
  ...
  in method STORE at src/gen/CORE.setting:8317<br />
  in sub infix:&lt;=&gt; at src/gen/CORE.setting:14952<br />
...
Undefined routine '&amp;prefix:&lt;\&gt;' called (lines 96, 96)<br />
    ...
    ------&gt;     for ($i = 1; my $x ⏏= $i; ) {<br />
===SORRY!===<br />
Could not find sub cuid_96_1376992337.79791<br />
</td></tr>
...
------&gt;  ($@ =~ /^(Unsupported script encoding \⏏Q$enc\E)/) {</td></tr>
        ...
        <tr><td>nqp --version</td><td colspan='5'>This is nqp version 2013.07-93-gde7cd46 built on parrot 5.5.0 revision RELEASE_5_5_0
</td></tr>
        <tr><td>perl6 --version</td><td colspan='5'>This is perl6 version 2013.07-260-g71141df built on parrot 5.5.0 revision RELEASE_5_5_0
</td></tr>
    </tbody>
</table>

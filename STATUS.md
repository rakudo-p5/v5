...
use of uninitialized value of type Any in string context  in block  at t/spec/base/term.v5:32
        ...
        <tr><td colspan=5>===SORRY!===
Two terms in a row
at t/spec/benchmark/rt26188-speed-up-keys-on-empty-hash.v5:11
------> rt26188 - benchmark speed for keys() ⏏on empty hashes</td></tr>
...
at t/spec/bigmem/read.v5:13
------> $ENV{PERL_TEST_MEMORY}⏏ >= 3</td></tr>
        <tr align=center><td align=left rowspan=2>bigmem/vec.v5</td><td>0</td><td>7</td><td>0</td><td>0</td><td>7</td></tr>
        <tr><td colspan=5>===SORRY!===
Variable '%ENV' is not declared
at t/spec/bigmem/vec.v5:13
------> $ENV{PERL_TEST_MEMORY}⏏ >= 1</td></tr>
...
Method 'ast' not found for invocant of class 'NQPMu'
        ...
        <tr><td colspan=5>===SORRY!===
Anonymous variable requires declarator
...
Error while compiling block : Error while compiling block  (source text: "{\n    chdir 't' if -d 't';\n    @INC = qw(. ../lib);\n#    require \"./test.pl\";\n}"): Error while compiling op p6store (source text: "="): Unknown QAST node type NQPMu
        ...
        <tr><td colspan=5>===SORRY!===
Variable '%Config' is not declared
at t/spec/io/eintr.v5:31
------> unless (exists  $Config{'d_alarm'}⏏) {</td></tr>
        <tr align=center><td align=left rowspan=2>io/errno.v5</td><td>0</td><td>16</td><td>0</td><td>0</td><td>16</td></tr>
        <tr><td colspan=5>===SORRY!===
Variable '%ENV' is not declared
at t/spec/io/errno.v5:20
------>     $saved_perlio = $ENV{PERLIO}⏏;</td></tr>
...
Error while compiling block : Error while compiling block  (source text: "{\n    chdir 't' if -d 't';\n    @INC = qw(. ../lib);\n}"): Error while compiling op p6store (source text: "="): Unknown QAST node type NQPMu
        ...
        <tr><td colspan=5>===SORRY!===
Variable '%Config' is not declared
at t/spec/io/fflush.v5:22
------>  $useperlio = defined $Config{useperlio}⏏ ? $Config{useperlio} eq 'define' ? 1 :</td></tr>
...
Could not find sub &skip_all_without_perlio
        ...
        <tr><td colspan=5>===SORRY!===
Two terms in a row
at t/spec/io/perlio_leaks.v5:21
------> TODO⏏: {</td></tr>
...
Method 'returns' not found for invocant of class 'NQPMu'
        ...
        <tr><td colspan=5>===SORRY!===
Variable '$data2' is not declared. Did you mean '$data'?
at t/spec/io/through.v5:23
------> (my $data2⏏ = $data) =~ s/\n/\n\n/g;</td></tr>
...
Semicolon form of package definition not allowed in subscope;
  please use block form
at t/spec/mro/next_NEXT_utf8.v5:16
------>     ⏏use strict;</td></tr>
...
------> m has no SIGALRM") if !exists $SIG{ALRM}⏏;</td></tr>
        ...
        <tr><td colspan=5>===SORRY!===
Variable '%SIG' is not declared
at t/spec/mro/recursion_c3_utf8.v5:18
------> m has no SIGALRM") if !exists $SIG{ALRM}⏏;</td></tr>
...
------> m has no SIGALRM") if !exists $SIG{ALRM}⏏;</td></tr>
        ...
        <tr><td colspan=5>===SORRY!===
Variable '%SIG' is not declared
at t/spec/mro/recursion_dfs_utf8.v5:18
------> m has no SIGALRM") if !exists $SIG{ALRM}⏏;</td></tr>
...
at t/spec/op/each_array.v5:16
------> @array⏏ = qw(crunch zam bloop);</td></tr>
...
Semicolon form of package definition not allowed in subscope;
  please use block form
at t/spec/op/hash.v5:26
------> { package Class; ⏏DESTROY { ++$destroyed; } }</td></tr>
...
called from Sub '' pc 1127 (src/gen/perl6.pir:404) (src/main.nqp src/gen/main-version.nqp:52)
        ...
        <tr><td colspan=5>===SORRY!===
Confused
at t/spec/op/leaky-magic.v5:39
------>  my $name = s/./"qq|\\c$&|"/e⏏re;</td></tr>
...
at t/spec/op/reverse.v5:103
------>     is(sub { my $_ = shift; reverse }⏏->("bar"), "rab", 'reversal of default v</td></tr>
...
Method 'ast' not found for invocant of class 'NQPMu'
        ...
        <tr><td colspan=5>===SORRY!===
Variable '%Config' is not declared
at t/spec/op/study.v5:17
------> my $have_alarm = $Config{d_alarm}⏏;</td></tr>
...
Null PMC access in get_iter()
        ...
        <tr><td colspan=5>===SORRY!===
Variable '$line' is not declared. Did you mean '@lines'?
at t/spec/op/yadayada.v5:40
------> foreach my $line⏏ (@lines) {</td></tr>
...
Null PMC access in get_iter()
        ...
        <tr><td colspan=5>===SORRY!===
Variable '@ARGV' is not declared
at t/spec/porting/exec-bit.v5:68
------> <BOL>⏏<EOL></td></tr>
...
------> tests being done⏏:</td></tr>
        ...
        <tr><td colspan=5>===SORRY!===
Variable '%Config' is not declared
at t/spec/porting/globvar.v5:23
------> my $trial = "nm globals$Config{_o}⏏ 2>&1";</td></tr>
...
Method 'p5cc' not found for invocant of class '<anon>'
        ...
        <tr><td colspan=5>===SORRY!===
Two terms in a row
at t/spec/porting/pending-author.v5:59
...
Null PMC access in get_iter()
        ...
        <tr><td colspan=5>===SORRY!===
Variable '$NO_ENDING' is not declared
at t/spec/porting/regen.v5:15
...
------>    /^#A$/⏏p</td></tr>
        ...
        <tr><td colspan=5>use of uninitialized value of type Any in string context  in block  at t/v5/04-op.v5:49
...
at t/v5/05-anon-sub-lex-block.v5:9
------>     my $a = sub ⏏() { 
...
------> <BOL>⏏sub subr { $_[0] + $_[1] + 1 }</td></tr>
        ...
        <tr><td colspan=5>===SORRY!===
CHECK FAILED:
Calling proto of 'shift' will never work with no arguments (lines 12, 13, 59)
    Expected: :()
</td></tr>
...
------>     my $result = wantarray ? "LIST" ⏏: defined wantarray ? "SCALAR" : "VOID";</td></tr>
    ...
    at t/v5/16-var-redeclare.v5:15
    ------>     my $x ⏏= 1;
</td></tr>

...
sub EXPORT(|) {
    ...
    %ex<%Config> = (
        ...
        'cf_time' => 'Mon Mar 18 19:35:03 UTC 2013',
        'charbits' => '8',
        'charsize' => '1',
        'chgrp' => '',
        'chmod' => 'chmod',
        ...
        'd_ftime' => Mu,
        'd_futimes' => 'define',
        'd_gdbm_ndbm_h_uses_prototypes' => Mu,
        'd_gdbmndbm_h_uses_prototypes' => Mu,
        ...
        'd_mymalloc' => Mu,
        'd_ndbm' => 'define',
        'd_ndbm_h_uses_prototypes' => Mu,
        'd_nice' => 'define',
        'd_nl_langinfo' => 'define',
        'd_nv_preserves_uv' => Mu,
        'd_nv_zero_is_allbits_zero' => 'define',
        'd_off64_t' => 'define',
        'd_old_pthread_create_joinable' => Mu,
        'd_oldpthreads' => Mu,
        'd_oldsock' => Mu,
        'd_open3' => 'define',
        'd_pathconf' => 'define',
        'd_pause' => 'define',
        'd_perl_otherlibdirs' => Mu,
        'd_phostname' => Mu,
        'd_pipe' => 'define',
        'd_poll' => 'define',
        'd_portable' => 'define',
        ...
        'd_stdio_ptr_lval_nochange_cnt' => Mu,
        'd_stdio_ptr_lval_sets_cnt' => 'define',
        'd_stdio_stream_array' => Mu,
        'd_stdiobase' => 'define',
        'd_stdstdio' => 'define',
        'd_strchr' => 'define',
        'd_strcoll' => 'define',
        ...
        'myuname' => 'linux allspice 3.2.0-37-generic #58-ubuntu smp thu jan 24 15:28:10 utc 2013 x86_64 x86_64 x86_64 gnulinux ',
        'n' => '-n',
        'need_va_copy' => 'define',
